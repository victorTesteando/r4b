...
import { validateCSV, validateXLS } from '@/collaborators/functions/validationsDropZone'
...
const AddCollaboratorsFile = () => {
    ...
    const fileData= useSelector((state) => state.fileSavedCollaborators.data)
                        ...
                        <div className='container-download-file'>
                            ...
                            <div className="download-file">
                                ...
                                <div className='container-text-download-file'>
                                    <Image
                                        src="/images/load-file-collaborators.svg"
                                        width={25.79}
                                        height={27.59}
