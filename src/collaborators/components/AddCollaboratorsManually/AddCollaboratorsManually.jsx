...
const AddCollaboratorsManually = () => {
    ...
    const createEmptyCollaborators = (num) => {
        ...
        <div className="content-add-collaborators-manually">
            <div className="content-text">
                <Typography>
                    ...
                    O caso queira, puede ingresar los colaboradores importando un archivo <span className='text-hover'>aquí</span>
                </Typography>
